    ...
    <ul>
        ...
        <li>
            <div class="product_list qzlist2"
                ...
                <div class="clear"></div>
                <div id="page" class="M-box3" style="align: center;z-index: -1;margin-top:30px;margin-bottom:30px;">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data.list, function () {
                    html += '<li id="' + this.id + '"><div style="margin-left: 40px"><div class="product_pic"><img src="' + this.pictures + '" height="100px" width="100px"></div><div class="product_con"><div class="pro_info"><h2 style="height: 32px"><span style="text-align: justify">' + this.name + '<span style="color: #6d757a;font-size: large"><img src="images/pageviews.png"/>('+this.hit+')</span></span>';
                    if(this.hit>=500){
                ...
                $('li[id]').each(function () {
                    $(this).click(function () {
                        window.location.href = 'guideDetail.do?id=' + $(this).attr('id')
                    })
                })
            }
        });
